...
export default function Register() {
    ...
    const IDOnChange = (e) => {
        ...
        if (re.test(e.target.value)) {
            ...
            alert("Only alphabets, numbers, - and _ are allowed.")
        }
    }
            ...
            <form className="login-form" onSubmit={handlerSubmit}>
                <label>
                    ...
                    <ReactTooltip id="IDTooltip" place="right" effect="solid">
                        <span>User ID must contain 4 to 20 characters.<br />Only alphabets, numbers, - and _ are allowed.</span>
                    </ReactTooltip>
                    <input type="text"
                        className="input-register"
                        placeholder="4 ~ 20 characters"
                        data-tip="User ID must contain 4 to 20 characters. Only alphabets, numbers, - and _ are allowed."
                        maxLength="20"
                        value={userUniqueID}
                        autoFocus
