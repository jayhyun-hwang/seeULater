...
CREATE DATABASE IF NOT EXISTS `seeulater` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `seeulater`;
...
-- 테이블 데이터 seeulater.urls:~79 rows (대략적) 내보내기
DELETE FROM `urls`;
...
INSERT INTO `urls` (`url_id`, `user_id`, `url`, `title`, `icon_img`, `description`, `memo`, `directory`, `regdate`, `deldate`, `read`) VALUES
	...
	(83, 1, '', NULL, NULL, NULL, NULL, NULL, '2021-09-27 12:26:35', '2021-09-27 12:26:45', 0),
...
-- 테이블 데이터 seeulater.users:~0 rows (대략적) 내보내기
DELETE FROM `users`;
